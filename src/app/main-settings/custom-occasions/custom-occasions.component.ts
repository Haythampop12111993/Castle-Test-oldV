...
@Component({
  selector: 'app-custom-occasions',
  templateUrl: './custom-occasions.component.html',
  styleUrls: ['./custom-occasions.component.css']
})
export class CustomOccasionsComponent implements OnInit {
  ...
  getOccasions() {
    ...
    this.teamService.getOccasions('custom')
      .subscribe((res: any) => {
