...
@Component({
  selector: "app-legal-case-statuses",
  templateUrl: "./legal-case-statuses.component.html",
  styleUrls: ["./legal-case-statuses.component.css"],
})
export class LegalCaseStatusesComponent implements OnInit {
  add_status: any;
  ...
  addStatus() {
    ...
    this.legalCasesService.postCaseStatus(statusData).subscribe(
      (data: any) => {
        this.getAllStatuses();
        this.add_status = "";
  ...
  deleteStatus(id) {
    this.legalCasesService.deleteCaseStatus(id).subscribe(
      (data: any) => {
  ...
  getAllStatuses(page?) {
    this.legalCasesService.getCaseStatuses(page).subscribe(
      (data: any) => {
        this.statuses = data;
      },
      (err) => this.errorHandlerService.handleErorr(err)
  ...
  updateStatus() {
    ...
    this.legalCasesService
      .updateCaseStatus(this.current_selected_status.id, statusData)
      .subscribe(
        (res: any) => {
