    ...
    this.http
      .get(`${environment.api_base_url}dashboard/stats`, {
        params: {
          ...
          date_year: this.salesFilter.year ? this.salesFilter.year.value : "",
          date_month: this.salesFilter.month
            ? this.salesFilter.month.value
            : "",
          date_day: this.salesFilter.day ? this.salesFilter.day.value : "",
        },
      })
      .subscribe((data) => {
        this.statsData = data;
